...
def index():
	...
	if request.method == "POST":
                ...
                original_image = Image.open(os.path.join(app.config['EXISTNG_FILE'], 'original.png')).resize((250,160))
                original_image.save(os.path.join(app.config['EXISTNG_FILE'], 'original.png'))

                # Read uploaded and original image as array
                original_image = cv2.imread(os.path.join(app.config['EXISTNG_FILE'], 'original.png'))
